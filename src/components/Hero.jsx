...
function Hero({ onHowItWorks, onStart }) {
    return (
    <section className="grid lg:grid-cols-2 min-h-screen pt-24">
      <motion.div
      ...
      >
        <h1 className="text-6xl lg:text-[100px] leading-[0.92] font-serif text-[#151515]">
          The art of <br />
          giving the <br />
        ...
        <p className="mt-8 text-gray-500 text-lg lg:text-xl leading-9 max-w-xl">
